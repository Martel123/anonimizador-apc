...
class Case(db.Model):
    ...
    demandante = db.Column(db.String(300))
    demandado = db.Column(db.String(300))
    asesor_externo = db.Column(db.String(200))
    abogado_interno = db.Column(db.String(200))
    tipo_proceso = db.Column(db.String(150))
